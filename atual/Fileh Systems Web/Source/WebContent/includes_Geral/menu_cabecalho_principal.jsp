...
<html xmlns="http://www.w3.org/1999/xhtml"/>	
	...
	if(	(session.getAttribute("usuario") != null) && (session.getAttribute("subusuario") != null) && (!session.getAttribute("usuario").toString().equalsIgnoreCase("erro"))){
	...
	if(	(session.getAttribute("usuario") == null) || (session.getAttribute("subusuario") == null) ){
		...
		session.setAttribute("subusuario", null);
	};
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_menu" class="ddsmoothmenu">
		<ul>
			...
			<li><a href="usuarioLogin.jsp">Login</a></li>

...
public class ListagemContasReceberAction implements ActionProcess {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String tipoConta = "";
			String doc = "";
			String fl_situacao_recebido = "";
			String fl_situacao_naoRecebido = "";
			...
			if (fl_situacao.equalsIgnoreCase("T")){
				...
				fl_situacao_recebido = "";
				fl_situacao_naoRecebido = "";
			};

			if (fl_situacao.equalsIgnoreCase("S")){
				fl_situacao_recebido = "checked=\"checked\"";
				fl_situacao_todas = "";
				fl_situacao_naoRecebido = "";	
			}

			if (fl_situacao.equalsIgnoreCase("N")){
				fl_situacao_naoRecebido = "checked=\"checked\"";
				fl_situacao_recebido = "";
				fl_situacao_todas = "";	
			}	
			...
			request.getSession().setAttribute("fl_situacao_recebido", fl_situacao_recebido);
			request.getSession().setAttribute("fl_situacao_naoRecebido", fl_situacao_naoRecebido);
			...
			ArrayList <String> arrayFornecedor = forDAO.buscaFornecedoresListagemNomesContasReceber(u.getUsu_cd_usuario());
			ArrayList <String> arrayTipoConta = tipoContaDAO.buscaTipoContasListagemNomesContasReceber(u.getUsu_cd_usuario());
			...
			arrayContasReceber = contaReceberDAO.consultaContasReceber(u.getUsu_cd_usuario(), fl_situacao, filtroDataInicio, filtroDataFim, doc, codigo_conta, msgFornecedorValue, msgTipoContaValue);
			
			request.getSession().setAttribute("arrayContasReceber", arrayContasReceber);
			
			response.sendRedirect("listagemContasReceber.jsp");

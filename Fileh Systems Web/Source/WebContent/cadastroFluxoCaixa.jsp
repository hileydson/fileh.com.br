...
<body onload="FocusInput('id_flu_vl_fluxo_caixa')" id="id_body">
 ...
 <div id="dialog-form-alerta" title="Alerta..." class="dialog-position-top">
  <p class="validateTips">Favor escolher uma entidade, um pagamento/saída e preencher todos os campos necessários...</p>
</div>
...
<div>
	...
	<div align="left">
        ...
        <hr></hr>
		    ...
		    Pagamento/Saída :
			<select title="Forma de pagamento/saída" id="id_flu_ds_forma_pagamento" name="flu_ds_forma_pagamento"		style="width: 300px;" >
...
<form  name="cadastroFluxoCaixa" action="CadastrarFluxoCaixa.action" method="post" > 
        ...
        <td>Valor :</td>
		<td><input title="Insira o sinal de menos('-') para inserir uma saída..." value="R$ 0,00" maxlength="15" name="flu_vl_fluxo_caixa" id="id_flu_vl_fluxo_caixa" type="text" style=" width : 110px;" class="real"></input></td>
